...
This branch of Opal is for "DreamHost":http://www.dreamhost.com servers. It uses slightly different gems than the master branch, but should pretty much be the same in terms of functionality.
