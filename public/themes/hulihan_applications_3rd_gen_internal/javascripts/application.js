...
function activeTab(tab)
	{   
		...
		{callPage('/user/main/summary', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br> Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');}
		else if(tab == 2)
		{callPage('/user/main/add_item', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /> <br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');}
		else if(tab == 3)
		{callPage('/user/main/view_items', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');}
		else if(tab == 4)
		callPage('/user/main/view_settings', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');
	}	
function activeAdminTab(tab) // function for admin tabs
	{   
		...
		document.getElementById("tab"+tab).className = "active"; // make the current tab "active"
		if(tab == 1) // Admin Tab
		callPage('/admin/main/summary', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');
		else if(tab == 2) // Admin Tab
		callPage('/admin/main/summary', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');
		else if(tab == 3) // Admin Tab
		callPage('/admin/main/users', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');
		else if(tab == 4) // Admin Tab
		callPage('/admin/main/settings', 'content', '<img src=\"/themes/hulihan_applications_3rd_gen_internal/images/loading.gif\" /><br>Content is loading, Please Wait...', 'Error in Loading page <img src=\"images/error_caution.gif\" />');
	}	

function loading(id)
{
	 element = document.getElementById(id)
	 element.innerHTML = "<div class='loading'><img src='/themes/hulihan_applications_3rd_gen_internal/images/loading.gif' class='loading'></div>"
}
