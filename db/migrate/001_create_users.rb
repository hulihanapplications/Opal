class CreateUsers < ActiveRecord::Migration
  ...
  def self.down
    ...
    #FileUtils.cp("#{RAILS_ROOT}/default.png", avatars_path) # copy the default avatar into the recreated folder
    #FileUtils.cp("#{RAILS_ROOT}/1.png", avatars_path) # copy the admin avatar into the recreated folder
  end
end
