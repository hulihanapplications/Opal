...
* This branch of Opal is designed to run out of the box on "DreamHost":http://www.dreamhost.com servers. 
** This branch uses slightly different gems than the master branch, but should 
same in 
terms of functionality.
** This branch also supports fastcgi, since "Rails 3.1":http://wiki.dreamhost.com/Rails_3 apps don't run well Dreamhost's configuration of passenger.
...
<pre>
git clone -b dreamhost git://github.com/hulihanapplications/Opal.git
</pre>
...
<pre>
cd Opal
# Save your user's GEM_HOME location
echo $GEM_HOME > config/gem_home
