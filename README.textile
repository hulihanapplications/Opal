...
This assumes that the database is already created by you. If your database server is located somewhere else, be sure to specify its location with the _host_ attribute. 
