...
{
	 element = document.getElementById(id)
	 element.innerHTML = "<div class='loading'><img src='/themes/vault/images/loading.gif' class='loading'></div>"
}
...
function toggle_expanding_box(box_id, link_id)
{
	...
	{
		link_element.innerHTML = '<img src="/themes/vault/images/icons/close.png" class="icon" title="Close">' 
	}
 	else // The Element is currently Visible
 	{
		link_element.innerHTML = '<img src="/themes/vault/images/icons/open.png" class="icon" title="Expand">' 	 	
	}
