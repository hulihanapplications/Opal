class ZeroTwoOneNewFeatures < ActiveRecord::Migration
  def self.up
    ...
    PluginSetting.create(:plugin_id => @plugin.id, :name => "item_thumbnail_height", :title => "Item Thumbnail Height",  :value => "125", :setting_type => "Plugin", :description => "TThis is the height(in pixels) of the thumbnails that are generated.", :item_type => "string")           
