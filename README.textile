...
* Mass file uploader
* Store files locally or in the cloud using Amazon S3, Rackspace Cloud Files, etc. - "(Guide)":http://dev.hulihanapplications.com/wiki/opal/Upload
* Apply special effects to Images(Rotate, Resize, Watermark, Stamp, B&W, Sepia, etc.)
