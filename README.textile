...
* This branch of Opal is for "DreamHost":http://www.dreamhost.com servers. It uses slightly different gems than the master branch, but should same in terms of functionality.
